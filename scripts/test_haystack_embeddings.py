#!/usr/bin/env python3
"""Vertex 임베딩이 passage 문서와 1:1로 정렬됐는지 검증한다."""
...
DOCUMENTS = ROOT / "rag" / "haystack_passages.jsonl"
...
assert len(documents) == len(embeddings) == 2_706
...
print("OK: Vertex 다국어 임베딩 2,706개 · 256차원 · 문서 ID 정렬 검증 완료")
